        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 6 }}>
          ...
          {bestaande.map(k => (
            <button key={k.kleur} type="button" onClick={() => onChange(k.kleur, k.kleur_hex)}
              ...
              <span style={{ width: 10, height: 10, borderRadius: '50%', background: kleurHex(k.kleur, k.kleur_hex), border: '1px solid rgba(0,0,0,0.18)' }} />
              {k.kleur}
            </button>
          ))}
        </div>
            ...
            {regels.map(it => (
              <div key={it._localId} style={{ display: 'flex', alignItems: 'flex-end', gap: 8, padding: '6px 0', borderBottom: '1px solid var(--border)' }}>
                <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 6 }}>
                  {it.kleur && <span style={{ width: 10, height: 10, borderRadius: '50%', background: kleurHex(it.kleur, it.kleur_hex), border: '1px solid rgba(0,0,0,0.18)', flexShrink: 0 }} />}
                    ...
                    {overzichtGefilterd.map(o => {
                      ...
                      return (
                        <tr key={key}>
                          ...
                          <td style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                            {o.kleur && <span style={{ width: 10, height: 10, borderRadius: '50%', background: kleurHex(o.kleur, o.kleur_hex), border: '1px solid rgba(0,0,0,0.18)', flexShrink: 0 }} />}
